...
| 🏛️ Module Geospatial | [API module geospatial v1.0.3 (definitief)](https://gitdocumentatie.logius.nl/publicatie/api/mod-geo/) | [API module geospatial (werkversie)](https://logius-standaarden.github.io/API-mod-geospatial/) | [ API-mod-geospatial](https://github.com/Logius-standaarden/API-mod-geospatial) |
